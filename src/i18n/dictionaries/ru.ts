...
const ru: Dictionary = {
  meta: {
    ...
    description:
      "ZOND — агентство брендинга с 2021 года. Стратегия, айдентика, дизайн, SMM, упаковка, брендбуки и цифровые решения для бизнеса в Украине и мире.",
    keywords: [
      "брендинг",
      "айдентика",
      "дизайн",
    ...
    ogImageAlt: "ZOND Agency — брендинг и дизайн",
  },
  nav: {
    services: "Услуги",
    projects: "Проекты",
  ...
  a11y: {
    ...
    vision: "Vision",
    playVideo: "Воспроизвести видео ZOND",
  ...
  mission: {
    ...
    clientsTrust: "нам доверяют",
  },
  projects: {
    title: "Бренды, которые вдохновляют",
  ...
  team: {
    title: "Люди, которые создают смыслы",
    items: [
      { name: "Алекс Крутих", role: "Основатель", image: "/assets/team/oleksandr-krutykh.webp" },
      { name: "Мария Супряга", role: "Дизайнер", image: "/assets/team/maria-supriaha.jpg" },
      { name: "Елизавета Полунина", role: "Арт-директор", image: "/assets/team/elyzaveta-polunina.jpg" },
      { name: "Дмитро Кавелашвілі", role: "Аккаунт", image: "/assets/team/dmytro-kavelashvili.webp" },
      { name: "Мария Дубова", role: "SMM", image: "/assets/team/maria-dubova.jpg" },
      { name: "Наталия Машталяр", role: "SMM", image: "/assets/team/natalia-mashtaliar.jpg" },
    ],
  },
  cta: {
    title: "Обсудим ваш проект?",
    description:
      "Расскажите о вашем бизнесе, и мы предложим решение, которое работает именно для вас.",
    button: "Консультация",
  },
  footer: {
  ...
  notFound: {
    ...
    description:
      "Похоже, вы попали на несуществующую страницу, или она была перемещена.",
    backHome: "На главную",
