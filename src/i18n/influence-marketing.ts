...
const en: ServicePageContent = {
  ...
  process: [
    { index: "01", title: "Request and briefing", description: "You submit a request; we discuss the product, niche, and budget in detail.", duration: "1 day" },
    { index: "02", title: "Influencer and format selection", description: "We build a list of influencers that match campaign goals and budget.", duration: "2–5 days" },
    { index: "03", title: "Creative approval", description: "We develop the campaign plan and approve integration concepts with bloggers.", duration: "1–3 days" },
    { index: "04", title: "Campaign launch", description: "The campaign starts according to the agreed publishing schedule.", duration: "1–4 weeks" },
    { index: "05", title: "Analytics report", description: "After the campaign we provide stats: reach, views, clicks, and conversions.", duration: "1–2 days" },
  ],
...
const ru: ServicePageContent = {
  ...
  process: [
    { index: "01", title: "Заявка и брифинг", description: "Вы оставляете заявку, мы детально обсуждаем продукт, нишу и бюджет.", duration: "1 день" },
    { index: "02", title: "Подбор блогеров и форматов", description: "Формируем список инфлюенсеров, которые соответствуют целям кампании и бюджету клиента.", duration: "2–5 дней" },
    { index: "03", title: "Согласование креатива", description: "Разрабатываем план кампании и согласуем концепцию интеграций с блогерами.", duration: "1–3 дня" },
    { index: "04", title: "Запуск рекламы", description: "Кампания стартует согласно согласованному графику публикаций.", duration: "1–4 недели" },
    { index: "05", title: "Отчёт с аналитикой", description: "После завершения кампании предоставляем статистику: охваты, просмотры, клики и конверсии.", duration: "1–2 дня" },
  ],
